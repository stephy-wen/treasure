						...
						<h2 class="accordion-header" :id="`flush-heading${index}`">
							<button 
								...
								<div class="d-flex justify-content-between align-items-center w-100">
									<span class="fs-5 winnie-color-gray">{{ transaction.type }}</span>
									<span class="fs-5 me-2 fw-bold">{{ transaction.amount }}</span>
								</div>
							</button>
						</h2>
						<div 
								...
								<a href="#">
									<div class="accordion-li pt-2 pb-4 px-4">
										...
										<div class="d-flex justify-content-between round mt-2">
											...
											<a href="#"><img src="@/assets/images/icon/arcoDesign-launch 1.svg" alt=""></a>
										</div>
									</div>
								</a>
							</div>
