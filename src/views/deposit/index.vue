...
.winnie-deposit a button:hover,
.winnie-deposit a button:focus {
  color: #f8f8f8;
  background-color: #414d5a;
}

.winnie-deposit .vertical-line {
  width: 1px;
  background-color: #414d5a;
  height: 100px;
  margin: 0 20px;
...
.winnie-deposit .vertical-line.active {
