  ...
  <div class="container play-container px-0 mt-2 mt-md-3 mt-lg-5">
    <div class="d-flex align-items-center justify-content-between mt-3">
      ...
      <div class="col-4">
        ...
        <div class="player-limit d-none ps-3 align-items-center">
      ...
      <div class="game-intro mt-3">
        <div class="row">
          <div class="col-12 col-sm-7">
            <div class="game-intro-title d-flex justify-content-between align-items-center">
        ...
        <div class="col-12 col-sm-5 col-md-4 ms-md-auto d-flex flex-column justify-content-between">
            <div class="mt-2 justify-content-center player-list-hexagon d-none d-sm-flex ">
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/01.png');"></div>
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/02.png');"></div>
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/03.png');"></div>
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/04.png');"></div>
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/05.png');"></div>
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/06.png');"></div>
              <div class="hexagon me-1" style="background-image: url('../images/icon/NFT/07.png');"></div>
              <div class="hexagon hexagon-more" style="background-image: url('../images/icon/NFT/08.png');">
                <a href="#" data-bs-toggle="modal" data-bs-target="#playerListSmModal">
                <div class="overlay">
                  <div class="dots">
                    <div class="dot"></div>
                    <div class="dot"></div>
            ...
            <div class="game-attend mt-3">
                ...
                <div class="modal fade" id="winnerModal" tabindex="-1" aria-labelledby="winnerModalLabel" aria-hidden="true">
                  <div class="modal-dialog mx-auto modal-dialog-centered modal-fullscreen-sm-down">
                    <div class="modal-content modal-background" style="background-image: url('../images/common/attend_eth.png');">
                      ...
                      <div class="modal-body text-center d-flex flex-column justify-content-center">
                        ...
                        <div class="winner-info mt-5">
                          <img src="../images/icon/NFT/09.png" alt="">
